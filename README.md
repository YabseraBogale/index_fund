...
Modern Portfolio Theory (MPT): 
  Algorithms use your answers from a risk questionnaire to decide the exact mix of stock 
  and bond index funds you need.Dollar-Cost Averaging (DCA): The bot schedules recurring buys.
...
Tax-Loss Harvesting: 
  In taxable accounts, advanced bots automatically sell losing assets to offset capital gains
  and lower your tax bills.
